...
const SubscriptionCard = () => {
  return (
   ...
   >
<View style={{flexDirection:"row", alignItems:"center", height: 80, marginTop: 40}}>
       <Badge
         size={14}
         badgeStyle={{backgroundColor:theme.colors.green[4], top: 20, left: 15, zIndex: 2, width: 12, height: 12, borderRadius: 12}}
       />
       <Avatar
         source={require("../assets/images/oscarluna.png")}
         rounded
         size="medium"
         containerStyle={[Styles.avatar, { backgroundColor: theme.colors.red[5]}]}
       />
       <Text
         style={{
       ...
       <View style={{ top: 20, left: -70, flexDirection: "row" }}>
         ...
         <Image
           ...
           style={[Styles.icon, { marginLeft: 55, marginTop: -15, width: 25, height: 25 }]}
         />
       </View>
     ...
     <View style={Styles.footerContainer}>
       ...
       >
         ...
         <View style={{marginLeft: 5, flexDirection:"row", alignItems:"center", justifyContent: "space-evenly", marginVertical: 5}}>
           <Image source={require("../assets/images/icon-calendar.png")} style={{ resizeMode: "contain", width: 24, height: 24 }} />
           <Text style={{color: theme.colors.neutral[0], marginLeft: 15}}>S 
           <Text style={{color:theme.colors.green[4]}}>{" "}M T W R F{" "}</Text>S</Text>
         </View>
         <View
           style={{
             marginLeft: 5,
